...
public class ScooterPraktikumOrderPageModel {
    ...
    private final By scndPageRentalPeriodInput = By.xpath("//div[text()='* Срок аренды']");
    ...
    private void setRentalPeriod(String period) {
        WebElement rentalInput = driver.findElement(scndPageRentalPeriod).findElement(scndPageRentalPeriodInput);
        rentalInput.click();
    ...
    public boolean isOrderAccepted() {
        ...
        if (!driver.findElements(modalWindowOrderAcceptedTitle).isEmpty()) {
            WebElement modalWindowTitle = driver.findElement(modalWindowOrderAcceptedTitle);
            if (modalWindowTitle.isDisplayed() && modalWindowTitle.isEnabled()) {
